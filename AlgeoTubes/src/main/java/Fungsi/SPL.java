...
public class SPL {
    ...
    public static void main (String[] args){
        System.out.println(SPLGaussJordanFromMatrix(TextToMatriks.readMatrixFromFile("Algeo/filename.txt")));
    }
    
    /* ------------------------SPL From Cramer------------------------ */
    public static String SPLCramer(double[][] matrix, int matrix_size, int penyelesaian) {
